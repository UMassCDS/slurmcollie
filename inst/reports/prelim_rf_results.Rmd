...
- For each class (the 19 subclasses), we get the following statistics. These all scale from 0 to 1, with 1 
  ...
  - *Precision*, the proportion of positive cases that were predicted as positive
...
though subclass 4 could use some improvement (predicting classes along a gradient is inherently tricky).
